...
const pages = {
  ...
  es: {
    ...
    'homeschool-spelling-practice': {
      title: 'Spelling para homeschool y casa | My Spelling Game',
      ...
      ogDescription: 'Convierte tu lista de homeschool en práctica de spelling sin cuenta.',
      h1: 'Práctica de spelling para homeschool',
      ...
      panels: [
        ['Listas hechas por la familia', 'En homeschool la lista suele venir de un plan propio. Por eso el juego acepta cualquier lista y no impone palabras genéricas.'],
      ...
      faq: [
        ...
        ['¿Hace falta una plataforma homeschool?', 'No. Funciona en el navegador con un enlace sin cuenta.'],
      ],
    },
    'sight-word-typing-game': {
      title: 'Juego para practicar sight words | My Spelling Game',
      description: 'Pega una lista de sight words y conviértela en una práctica corta de typing. Útil para clase, casa y repaso sin cuenta.',
      ogDescription: 'Practica sight words con una lista propia y repite las palabras falladas.',
      h1: 'Juego para practicar sight words',
      intro: 'Pega los sight words que el niño está trabajando ahora y conviértelos en una ronda corta de escritura.',
      panels: [
        ['Mejor con listas pequeñas', 'Los sight words suelen necesitar repetición breve. Una lista corta funciona mejor que una actividad larga.'],
      ...
      faq: [
        ['¿Puedo pegar mi propia lista de sight words?', 'Sí. Usa la lista que el estudiante está practicando ahora.'],
  ...
  'pt-BR': {
    ...
    'homeschool-spelling-practice': {
      title: 'Spelling para homeschool em inglês | My Spelling Game',
      ...
      ogDescription: 'Transforme palavras de homeschool em prática de spelling sem conta.',
      h1: 'Prática de spelling para homeschool',
      intro: 'Use palavras do currículo, de uma apostila ou de uma lista feita em casa para criar uma rotina simples de spelling.',
      panels: [
        ['A lista vem do seu plano', 'No homeschool, a sequência de palavras nem sempre segue um banco pronto. Por isso a prática começa com a sua lista.'],
      ...
      faq: [
        ...
        ['Precisa de plataforma homeschool?', 'Não. Funciona no navegador com link sem conta.'],
      ],
    },
    'sight-word-typing-game': {
      title: 'Jogo para praticar sight words | My Spelling Game',
      description: 'Cole uma lista de sight words e pratique digitando. Útil para escola, casa e leitura inicial, sem login de aluno.',
      ogDescription: 'Pratique sight words com lista própria e revisão de erros.',
      h1: 'Jogo para praticar sight words',
      intro: 'Cole os sight words que a criança está aprendendo agora e transforme a lista em uma rodada curta de digitação.',
      panels: [
        ['Listas curtas funcionam melhor', 'Sight words pedem repetição frequente. Uma rodada curta ajuda sem cansar.'],
        ['Para aula ou casa', 'Use com listas do professor, listas Dolch/Fry ou palavras de leitura inicial.'],
      ],
      faq: [
        ['Posso usar minha lista de sight words?', 'Sim. Cole a lista que a criança está praticando.'],
  ...
  fr: {
    ...
    'homeschool-spelling-practice': {
      ...
      faq: [
        ...
        ['Faut-il une plateforme homeschool ?', 'Non. Tout fonctionne dans le navigateur avec un lien sans compte.'],
      ],
    },
    'sight-word-typing-game': {
      title: 'Jeu pour pratiquer les sight words | My Spelling Game',
      description: 'Collez une liste de sight words et lancez une courte pratique de frappe. Utile en classe, à la maison et sans compte.',
      ogDescription: 'Pratiquez les sight words avec une liste personnalisée et révisez les mots manqués.',
      h1: 'Jeu pour pratiquer les sight words',
      intro: 'Collez les sight words que l’enfant apprend en ce moment et transformez-les en courte partie de frappe.',
      panels: [
        ['Mieux avec une petite liste', 'Les sight words demandent des répétitions courtes et fréquentes. Une partie brève suffit souvent.'],
        ['Pour la classe ou la maison', 'Utilisez une liste du professeur, une liste Dolch/Fry ou des mots de lecture débutante.'],
      ],
      faq: [
        ['Puis-je coller ma liste de sight words ?', 'Oui. Utilisez la liste travaillée en ce moment.'],
  ...
  id: {
    ...
    'sight-word-typing-game': {
      title: 'Game latihan sight words | My Spelling Game',
      description: 'Tempel daftar sight words dan jadikan latihan mengetik singkat. Cocok untuk kelas, rumah, dan latihan membaca awal.',
      ogDescription: 'Latih sight words dari daftar sendiri dan ulangi kata yang salah.',
      h1: 'Game latihan sight words',
      intro: 'Tempel sight words yang sedang dipelajari anak dan ubah menjadi ronde mengetik singkat.',
      panels: [
        ['Lebih enak dengan daftar pendek', 'Sight words biasanya perlu pengulangan singkat. Ronde kecil membuat latihan terasa ringan.'],
        ['Untuk kelas atau rumah', 'Gunakan daftar dari guru, daftar Dolch/Fry, atau kata-kata membaca awal.'],
      ],
      faq: [
        ['Bisa memakai daftar sight words sendiri?', 'Bisa. Tempel daftar yang sedang dipelajari siswa.'],
  ...
  zh: {
    ...
    'sight-word-typing-game': {
      title: 'Sight Words 打字练习 | My Spelling Game',
      description: '粘贴 sight words 词表，生成短轮次打字练习。适合课堂、家庭阅读启蒙和错词重练，无需学生登录。',
      ogDescription: '用自己的 sight words 词表做打字练习，支持错词重练。',
      h1: 'Sight Words 打字练习',
      intro: '把孩子正在学习的 sight words 粘贴进来，变成一轮简短的英文打字练习。',
      panels: [
        ['短词表更适合反复练', 'Sight words 需要高频重复，短轮次比长任务更容易坚持。'],
        ['适合课堂或家庭', '可以用老师给的词表、Dolch/Fry 风格词表，或家庭阅读启蒙词表。'],
      ],
      faq: [
        ['可以用自己的 sight words 词表吗？', '可以。粘贴孩子当前正在练的词即可。'],
